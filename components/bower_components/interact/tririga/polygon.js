Polygon = {
	/*
	 * retreive points in polyline element
	 */
	...
	/*
	 * return true of false if rec1 (x1, y1, w1, h1) contains rec2 (x2, y2, w2, h2)
	 * x, y the the base coordinate, w is the width, h is the height
