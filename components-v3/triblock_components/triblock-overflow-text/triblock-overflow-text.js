...
/*
`triblock-overflow-text` is a component that handles the overflow text and displays the text in ellipsis based on no. of lines given. The component implements `iron-resizable-behavior`.
...
Polymer({
    _template: html`
		<style include="tristyles-theme">
				...
				.overflow-indicator {
					background-color: var(--triblock-overflow-text-ellipsis-background-color, inherit);
					bottom: 0;
					position: absolute;
					text-align: right;
				}
				...
				.ellipsis {
					...
					line-height: var(--triblock-overflow-text-ellipsis-line-height, normal);
				}
				...
				.collapse-link {
					font-size: var(--triblock-overflow-text-collapse-link-font-size, "inherit");
				}
