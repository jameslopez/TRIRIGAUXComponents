...
const importJsPromise = importJs(
	...
	"triblock-carousel/triblock-carousel.js"
);
...
*/
    Polymer({
		...
		<style include="iron-flex iron-flex-alignment iron-flex-factors iron-positioning tristyles-theme">
				...
				#content>::slotted(:not(.iron-selected):not(.transition)) {
					display: none;
				}
				...
				#content>::slotted(:not(.transition)) {
					order:999;
				}

				#content>::slotted(.transition) {
					position: absolute;
					pointer-events: none;
				}
				...
				paper-icon-button{
					--paper-icon-button:{
						color: var(--triblock-carousel-buttons-color, var(--tri-primary-content-label-color));
						opacity: 0.7;
						padding: 0;	
					};
				}
				...
				.carousel-indicator {
					...
					border-width: 1px;
					border-style: solid;
					border-color: var(--triblock-carousel-dot-indicator-selected-color, var(--tri-primary-content-label-color));
					margin: 5px;
				...
				.carousel-indicator.iron-selected{
					background-color: var(--triblock-carousel-dot-indicator-selected-color, var(--tri-primary-content-label-color));
				}
	...
	`,
	    ...
	    behaviors: [IronSelectableBehavior, NeonAnimationRunnerBehavior, TriDirBehavior],
