...
Polymer({
    _template: html`
		...
		<paper-icon-button primary="" class="icon" icon="[[_computeIcon(icon, documentFileName)]]" title="download [[documentName]]" aria-label\$="download [[documentName]]" on-tap="_handleDownloadTap" disabled="[[disabled]]">
		</paper-icon-button>
