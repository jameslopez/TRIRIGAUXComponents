...
class TridocumentDownloadDemo1 extends PolymerElement {
	static get template() {
        return html `
            <style>
                paper-material {
            ...
            <paper-material elevation="1">
                <triplat-document-download document-id="[[document._id]]" document-name="[[document.name]]" document-file-name="[[document.fileName]]">
...
window.customElements.define('triplat-document-download-demo-1', TridocumentDownloadDemo1);