    ...
    _template: html`
		<style include="tristyles-theme">
			...
			#main {
				...
				overflow: auto; 
				max-height: 50vh;
				background-color: var(--triplat-search-input-expand-filters-background-color, var(--tri-primary-color-10));
			}
			...
			.clear-filter-icon{
				...
				min-height: 32px;
				margin: 3px;
				color: var(--triplat-search-input-expand-filters-remove-icon-color, var(--tri-primary-color));
				cursor: pointer; 
			}
			...
			.footer-container {
				...
				@apply --layout-self-center;
				font-size: 14px;
				color: var(--triplat-search-input-dropdown-footer-deselect-text-color, var(--tri-primary-dark-color));
				margin-right: 12px;
			}
